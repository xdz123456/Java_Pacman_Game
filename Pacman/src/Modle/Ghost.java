...
public class Ghost extends Rectangle implements Runnable {
    ...
    public Ghost(double x, double y, String img, Maze maze, GameManager gameManager, Pacman pacman) {
        this.setX(x);
        this.setY(y);
        this.maze = maze;
        ...
        FileInputStream input = null;
      	try {input = new FileInputStream(img);} 
      	catch (FileNotFoundException e) {e.printStackTrace();}
        Image ghost = new Image(input);
        ImagePattern ghost_IP = new ImagePattern(ghost); 
        this.setFill(ghost_IP);
